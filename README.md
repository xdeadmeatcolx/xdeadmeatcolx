...
<div class="container"> <span class="text" align="middle"></br>
        ...
        ${{\color{#c68a6b} ⠀⠀ ⠀⠀ ⠀⠀ ⠀area}}$ ${{\color{#89454d}changes⠀depending⠀on⠀fandom/fronter}}$</br>
        ${{\color{#c68a6b} ⠀⠀ ⠀⠀ ⠀⠀ ⠀frqing}}$ ${{\color{#89454d}after⠀interacting⠀is⠀encouraged⠀we⠀need⠀friends⠀on⠀here}}$</br>
        ${{\color{#c68a6b} ⠀⠀ ⠀⠀ ⠀⠀ ⠀we}}$ ${{\color{#89454d}block⠀freely⠀and⠀are⠀nonconfrontational}}$</br>
        ${{\color{#c68a6b} ⠀⠀ ⠀⠀ ⠀⠀ ⠀usually}}$ ${{\color{#89454d}offtab⠀but⠀we⠀disconnect⠀often}}$</br>
